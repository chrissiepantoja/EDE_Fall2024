...
NTL_1999 <- filter(NTL.phys.data, year4 %in% c(1999))
View(NTL_1999)

#Alternative: filter(NTL.phys.data, year4 = 1999)

# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.

NTL_1990_1999 <- 
  filter(NTL.phys.data, year4 %in% c(1990:1999) & lakename %in% c("Tuesday Lake"))

#Alternative 1: filter(NTL.phys.data, (lakename == 'Tuesday Lake') & (year4 %in% c(1990:1999))
#Alternative 2" NTL_1990_1999 <- NTL.phys.data %>%
...
View(NTL.phys.datapro_1990_1999)
