...
# the exclamation will do the oppositve of the vector 3
!vector3
...
matrix1[4,  ] # The 4th row of the matrix

matrix1[ , 3] # The 3th colum of the matrix

matrix1[c(12, 14)] # just the row with values

matrix1[c(12:14)] #

matrix1[2:4, 1:3] # from 2th to 4th row, and 1st to 3th column
...
# Will give you all the elements of that list
list1

# Will show you everything that is inside that list
list1$age

# Will get the names of that list
names(list1)

# 
list1[1:2]
list1[[1] # will give you only the value of the list 
...
## Data Frames
### Creating dataframes
#They need to have the same number of rows, with list there is no problem.
...
# $ sign to add a column in the dataset
```
