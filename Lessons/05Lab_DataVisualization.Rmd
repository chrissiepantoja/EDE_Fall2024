...
class(PeterPaul.chem.nutrients$months)

#List unique values
unique(PeterPaul.chem.nutrients$months)
...
PeterPaul.chem.nutrients_plot <- PeterPaul.chem.nutrients %>% 
  filter(depth==0) %>%
  ggplot(aes(x=daynum,
             y=temperature_C,
             color=year4))+
...
PeterPaul.chem.nutrients_plot2 <- PeterPaul.chem.nutrients %>% 
...
#Show the basic plot
PeterPaul.chem.nutrients_plot2
